         ...
         $('#exampleModal').on('show.bs.modal', function (e) {
             ...
             $.getJSON(url, function (data) {
                 if((data.nativeName!==null)&&(data.nativeName!=='None')) { 
                     ...
                     $('#contactModalLabel').text(data.nativeName);
                ...
                $('#contactURL').text('http://www.oknrd.ru/objects/'+data.id)
                $('#contactURL').attr('href', '/objects/'+data.id)
                //$('#modal_contact').attr('href', '/contact/'+data.id)
